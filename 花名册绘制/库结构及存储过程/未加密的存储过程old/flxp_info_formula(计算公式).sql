...
--SELECT * FROM gs_property
--select DBO.get_dictidname('AB01.ZA0100','AB0110') from AA01
	...
	begin
	   ...
	   if @tablename=''
		...
		begin
			set @strsql="update "+@infoid+" set "+@infofield+"=DBO.get_dictidname("+@tablename+","+@formulaFieldname+")  WHERE  "+@subCondition +" and "+@Condition+" and "+@rycondition
		end
	--   else
	--	begin
